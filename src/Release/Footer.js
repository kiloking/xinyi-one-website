  ...
  return (
    ...
    >
      ...
      <div className="mt-14  w-full bottom-0 grid grid-cols-3 divide-x-4 divide-white ">
        <a href="tel:033682868" rel="noreferrer" className="bg-zinc-200 py-5 md:py-2 flex justify-center items-center"><img src={process.env.PUBLIC_URL+'/images/tel.png'} alt="" className="max-w-full w-2/3 md:w-1/3" /></a>
        <a href="https://www.facebook.com/profile.php?id=100093249848242&mibextid=LQQJ4d" target="_blank" rel="noreferrer" className="bg-zinc-200 p-2 flex justify-center items-center"><img src={process.env.PUBLIC_URL+'/images/fb.png'} alt="" className="max-w-full w-2/3 md:w-1/3"/></a>
        <a href="https://goo.gl/maps/af32QCmVyDv3S1hp7" target="_blank" rel="noreferrer" className="bg-zinc-200 p-2 flex justify-center items-center"><img src={process.env.PUBLIC_URL+'/images/map.png'} alt="" className="max-w-full w-2/3 md:w-1/3"/></a>
      </div>
    </div>
  )
}
